package id.ac.poliban.mi.prima024.homework_10b;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.mi.prima024.homework_10b";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Data Storage Types_024 PRIMA-E020320024");
